...
(1, 'full', 'Standard MarkItUp-Konfiguration', 'textile', 'bold,deleted,clips[Snippetname1=Snippettext1|Snippetname2=Snippettext2],formatting[h1|h2|h3|h4|h5|h6|p],italic,orderedlist,sub,sup,table,underline,unorderedlist');
