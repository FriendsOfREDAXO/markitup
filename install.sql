...
(1, 'full', 'Standard MarkItUp-Konfiguration', 'textile', 'bold,code,deleted,clips[Snippetname1=Snippettext1|Snippetname2=Snippettext2],formatting[h1|h2|h3|h4|h5|h6|p],image,italic,link[internal|external|mailto],orderedlist,quote,sub,sup,table,underline,unorderedlist');
