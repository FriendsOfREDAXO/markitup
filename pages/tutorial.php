<?php
	...
	$code .= '      <textarea cols="1" rows="6" class="form-control markitupEditor-full" id="markitup_1" name="REX_INPUT_VALUE[1]">REX_VALUE[1]</textarea>'.PHP_EOL;
	$code .= '    </div>'.PHP_EOL;
	$code .= '  </div>'.PHP_EOL;
	...
	$code = '';
	$code .= '<?php'.PHP_EOL;
	$code .= '  rex_markitup::insertProfile(\'simple\', \'beschreibung\', \'textile\', \'bold,italic\');'.PHP_EOL;
	$code .= '?>'.PHP_EOL;
